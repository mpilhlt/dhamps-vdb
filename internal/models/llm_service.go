...
type LLMService struct {
	LLMServiceHandle string `json:"llmservice_handle" minLength:"3" maxLength:"20" example:"GPT-4 API" doc:"Service name"`
...
// Put/post llmservice
// PUT Path: "/llmservices/{user_handle}/{llmservice_handle}"
...
type PutLLMRequest struct {
	...
	LLMServiceHandle string `json:"llmservice_handle" path:"llmservice_handle" maxLength:"20" minLength:"3" example:"my-gpt-4" doc:"LLM service handle"`
	Body             struct {
		LLMService LLMService `json:"llm_service" doc:"LLM service to create or update"`
	}
}

// POST Path: "/llmservices/{user_handle}"
...
type UploadLLMResponse struct {
	...
	Body   struct {
		LLMServiceHandle string `json:"llmservice_handle" doc:"Handle of created or updated LLM service"`
	}
}
